            ...
            try {
              ...
              await widgets.requestPayment({
                ...
                successUrl:
                  ...
                  `/checkout/success?eventId=${event.id}&eventDatetimeId=${currentTempOrder.eventDatetimeId}&seats=${encodeURIComponent(JSON.stringify(currentTempOrder.seats.map((seat) => seat.id)))}`,
